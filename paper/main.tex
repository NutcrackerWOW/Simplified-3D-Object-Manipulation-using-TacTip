...
coupled force--torque capacity of a compliant patch, and the grasping
literature has long known that torsional load eats tangential capacity. Our
...
reduces tangential capacity. Our measurements are consistent with that
picture and go beyond it in two ways: the failing rotation here is about
...
boundary as a deployable scalar field $\mueff(\phi,\theta,m)$ rather than a
...
\begin{figure*}[t]
  \centering
  \includegraphics[width=0.67\textwidth]{figs/F3_shapes_materials.pdf}
